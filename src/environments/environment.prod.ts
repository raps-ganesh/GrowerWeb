...
export const environment = {
  ...
  receivingApiBaseUrl: 'https://10.12.96.194:3101/api/receiving/',
  gradingApiBaseUrl: 'https://10.12.96.194:3001/api/grading/',
  growerPortalApiBaseUrl: 'https://gpauthentication.diamondfoods.com:4201/api/authenticate/',
  adminApiBaseUrl: 'https://10.12.96.192:4101/api/admin/',
  documentApiBaseUrl: 'https://10.12.96.192:4301/api/Document/',
  imagePathUrl: 'https://testgo.diamondfoods.com/assets/contents/analyzer_Images/',
  reportsBaseUrl: 'https://10.12.96.194:3301/reporting/',
  cropyear: new Date().getMonth() > 8 ? new Date().getFullYear() : new Date().getFullYear() - 1,
  growerAccountingApiBaseUrl: 'https://10.12.96.194:3201/api/groweraccounting/',
  statementPath: 'https://testgo.diamondfoods.com/assets/contents/GrowerPortalStatements/',
  masterDataBaseUrl: 'https://10.12.96.194:340/api/master/',
};
